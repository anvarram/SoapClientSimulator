...
<%
   String url = request.getParameter("svrUrl") != null ? request.getParameter("svrUrl") : "";
   String input_xml = request.getParameter("input_xml") != null ? request.getParameter("input_xml") : "";
   String output_xml = "";
   
  

   if(url != null && !url.trim().equals("")){
	  SOAPClientSimulator client = new SOAPClientSimulator(url,input_xml,false);
...
<br>e.g. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;: http://hostname:port/sampleapi
</p>
